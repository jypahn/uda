...
class MyArticleAdapter(private val articleList: List<ArticleModel>) :
    RecyclerView.Adapter<MyArticleAdapter.ArticleViewHolder>() {
    ...
    inner class ArticleViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(article: ArticleModel) {
            ...
            itemView.setOnClickListener {
                val intent = Intent(itemView.context, MyArticleDetail::class.java)
